	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="box box-primary" id='detaildataagenda' >
				</div>
			</div>
		</div>
	</div>
...
<script>
	$(document).ready(function(){
		$.ajaxSetup({
			type:"POST",
			url: "<?php echo base_url(); ?>Pengguna/Agenda/ajax_agenda",
			cache: false,
		});
		$('.detail_data').click(function(){
		var id = $(this).attr("id");
		var modul = 'modul_detail_data_agenda';
		$.ajax({
			data: {id:id,modul:modul},
			success:function(data){
			$('#detaildataagenda').html(data);
