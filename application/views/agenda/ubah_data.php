                    ...
                    <?= $this->session->flashdata('gagal') ?>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('Agenda/ubah_data'); ?>" method="post" enctype='multipart/form-data'>
                                        <div class="form-body">
                                            <!-- <div class="row">
                                                <div class="col-md-2">
                                                <h4>Bukti Surat*</h4>
                                            ...
                                            <?php
                                            foreach ($data_agenda as $key => $value) {
                                            ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-error form-md-floating-label">
                                                        <div class="input-icon">
                                                            ...
                                                            <input type="date" name="tanggal" class="form-control" value="<?= $value->tanggal; ?>" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-error form-md-floating-label">
                                                        <div class="input-icon">
                                                            ...
                                                            <input type="time" name="jam" class="form-control" value="<?= $value->jam; ?>" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-info form-md-floating-label">
                                                        <div class="input-icon">
                                                            <input type="text" name="tempat" class="form-control" value="<?= $value->tempat; ?>" maxlength="200" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input has-warning form-md-floating-label">
                                                        <div class="input-icon">
                                                            <input type="text" name="acara" class="form-control" value="<?= $value->acara; ?>" maxlength="300" required>
                                            ...
                                            <div class="row" >
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input has-info form-md-floating-label">
                                                        <div class="input-icon">
                                                            <textarea name="peserta" class="form-control" maxlength="1000" required><?= $value->peserta; ?></textarea>
