...
<tr>
<td colspan='4'><b>Rekap Data Keikutsertaan Anggota Sekretariat Dewan </b> <br> Update : <font color='red'><?php echo date('d-m-Y')?> | <?php echo date('H:i')?> WIB</font></td>
</tr>
<tr>
...
header("Content-Disposition: attachment; filename=Rekap Data Setwan.xls");
