                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo site_url('Laporan/catatan_badan'); ?>" class="form-horizontal form-bordered" method='post'>
                                        <input type="hidden" name="id_badan" value="<?= $this->uri->segment(3); ?>">
                                        <div class="form-body">
