...
<script type="text/javascript">        
    ...
    document.getElementById("clock").innerHTML = (sh.length==1?"0"+sh:sh) + ":" + (sm.length==1?"0"+sm:sm) + ":" + (ss.length==1?"0"+ss:ss);
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title">Hasil Kerja
                        <small>Pansus</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    ...
                    <?php
                    foreach ($detail_pansus as $key => $row) {
                        echo '
                            <div class="m-heading-1 border-green m-bordered">
                                                            <h3> Pansus (Panitia Khusus) '.$row->nama_pansus.'</h3>
                                                            ...
                                                            <p style="text-align: justify;"> Jumlah Anggota : '.count($data_pansus).' orang. </p>
                            ...
                            <div class="portlet light form-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold">Catatan</span>
                                    </div>
                                   
                                </div>
                                <div class="portlet-body form">
                                 
                                    <form action="<?php echo site_url('Laporan/catatan_pansus'); ?>" class="form-horizontal form-bordered" method='post'>
                                        <input type="hidden" name="kode_pansus" value="<?= $this->uri->segment(3); ?>">
                                        <div class="form-body">
                                            <div class="form-group">
                                                <label class="control-label col-md-2">In Here</label>
                                                <div class="col-md-10">
