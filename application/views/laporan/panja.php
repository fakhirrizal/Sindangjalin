                    ...
                    foreach ($detail_panja as $key => $row) {
                        echo '
                            <div class="m-heading-1 border-green m-bordered">
                                                            <h3> Panja (Panitia Kerja) '.$row->nama_panja.'</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light form-fit bordered">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="<?php echo site_url('Laporan/catatan_panja'); ?>" class="form-horizontal form-bordered" method='post'>
                                        <input type="hidden" name="kode_panja" value="<?= $this->uri->segment(3); ?>">
                                        <div class="form-body">
