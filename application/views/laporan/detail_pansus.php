                    ...
                    foreach ($detail_pansus as $key => $row) {
                        echo '
                            <div class="m-heading-1 border-green m-bordered">
                                                            ...
                                                            <p style="font-size: 11px">Berikut adalah hasil kerja dari dibentuknya Pansus ini.</p>';
                                                            if(empty($row->hasil)){
                    ...
                    ?>
                            ...
                            <div class="portlet box yellow">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-social-dropbox"></i>Anggota Pansus (Jabatan di Pansus)</div>
                                    <div class="tools">
