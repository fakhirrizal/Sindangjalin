                    ...
                    <h3 class="page-title">Update Data
                        <small>Jabatan Anggota dalam Panja</small>
                    </h3>
                    <!-- END PAGE TITLE-->
                    <!-- END PAGE HEADER-->
                    <div class="row">
                            ...
                            <div class="portlet red-pink box">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        foreach ($data_panja as $key => $value) {
                                            echo 'PANSUS '.$value->nama_panja.' ('.count($anggota_panja).' anggota)';
                                        }
                                        ?>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">                
                                            <form action="<?php echo site_url('Master/update_jabatan_panja'); ?>" method="post">
                                                <table class="table">
                                                    <tbody>
                                                    <?php
                                                    $i = 0;
                                                    foreach ($anggota_panja as $value) {
                                                    ?>
