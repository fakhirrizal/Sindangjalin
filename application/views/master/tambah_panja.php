                    ...
                    <?= $this->session->flashdata('gagal') ?>
                                    ...
                                    <div class="panel panel-success">
                                        ...
                                        <div class="panel-body">
                                            <ul>
                                                ...
                                                <li>Untuk jabatan/ posisi masing-masing anggota dalam Panja bisa ditambahkan setelah menyelesaikan inputan data Panja. </li>
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('Master/simpan_panja'); ?>" method="post" enctype='multipart/form-data'>
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                                        <div class="input-icon">
                                                            <input type="text" name="nama_panja" class="form-control" maxlength="200" required>
                                                            <label for="form_control_1">Nama Panja</label>
                                                            <span class="help-block">Tidak usah menyertakan nama Panja didepannya.</span>
                                                            <i class="icon-pin"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input has-warning form-md-floating-label">
                                                        <div class="input-icon">
                                                            ...
                                                            <span class="help-block">Paparkan alasan terkait pembentukan Panja.</span>
                                            ...
                                            <br>                                           
                                            <div class="form-group form-md-checkboxes">
                                                <label for="form_control_1">Periode Panja</label>
                                                <div>
