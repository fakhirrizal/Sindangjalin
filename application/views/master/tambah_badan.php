                    ...
                    <?= $this->session->flashdata('gagal') ?>
              					 <div class="portlet-title">
                                    <div class="panel panel-success">
                                        ...
                                        <div class="panel-body">
                                            <ul>
                                                <li>Untuk jabatan/ posisi masing-masing anggota dalam sebuah Badan bisa diubah pada halaman berikutnya. </li>
                                                <li>Tanggal diresmikannya Badan adalah tanggal ketika menyimpan data ini. </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body form">
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('Master/simpan_badan'); ?>" method="post" enctype='multipart/form-data'>
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                                        <div class="input-icon">
                                                            <input type="text" name="badan" class="form-control" maxlength="200" required>
