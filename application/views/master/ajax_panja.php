                                            ...
                                            ?>
                                            <input type="hidden" name="id" value="<?= $value->kode_panja; ?>">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input has-success form-md-floating-label">
                                                        <div class="input-icon">
                                                            <input type="text" name="nama_panja" class="form-control" maxlength="200" value="<?= $value->nama_panja; ?>" required>
                                                            <span class="help-block">Nama Panja</span>
                                                            <i class="icon-pin"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input has-warning form-md-floating-label">
                                                        <div class="input-icon">
                                                            ...
                                                            <span class="help-block">Perihal kenapa dibentuknya Panja.</span>
                                            ...
                                            <div class="form-group form-md-checkboxes">
                                                ...
                                                <div class="md-checkbox-inline">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="md-checkbox">
                                                            <input type="checkbox" id="anggota<?= $value->id; ?>" name="nama[]" value="<?= $value->id.'_'.$value->status_panja.'_'.$value->jabatan_panja; ?>" <?php if(!empty($value->status_panja)){echo 'checked';}else{echo '';} ?> class="md-check">
