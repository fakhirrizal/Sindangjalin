                    ...
                    <?= $this->session->flashdata('sukses') ?>
                        <p> 
                            <a class="btn red btn-outline" href="<?php echo site_url('Master/tambah_pansus')?>" target="_blank"><i class="icon-user-follow"></i>&nbsp;&nbsp;Tambah Data Pansus</a>
                        </p>
                <table class="table table-bordered table-striped" id="pansus">
                    ...
                    <tr class="gradeX">
                        ...
                        <td style="text-align: center">
                            <a class="btn btn-circle btn-icon-only yellow" href="<?php echo site_url('Master/jabatan_pansus/'.$kode_pansus)?>" title="detail data">
                                <i class="icon-eye"></i>
                            </a>
                            <a class="view_data btn btn-circle btn-icon-only green" data-toggle="modal" data-target="#ubah" title="ubah data" id='<?= $id."_".$kode_pansus; ?>'>
                                <i class="icon-wrench"></i>
                            </a>
                            <a class="btn btn-circle btn-icon-only red" href="<?php echo site_url('Master/hapus_pansus/'.$kode_pansus)?>" title="hapus data" onclick="return confirm('Anda yakin?')">
...
<div class="alert alert-info no-margin margin-top-10"> Catatan! Silahkan hapus data sekiranya sudah banyak (usahakan yang ada di tabel adalah data Pansus yang masih aktif), rekapan tetap ada di Laporan data Pansus. </div>
      <script>
      $(function () {
        $("#pansus").DataTable({
          "paging": true,
